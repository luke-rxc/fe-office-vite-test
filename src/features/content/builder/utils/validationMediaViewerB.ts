 ...
 * 미디어뷰어 B 컴포넌트
 */
export const MediaViewerBValidationSchema = Yup.object({
  contents: Yup.object().shape({
    align: Yup.string(),
    title: Yup.object().shape({
      text: Yup.string().max(
        MEDIA_VIEWER_B_TITLE_MAX_NUM,
        `최대 ${MEDIA_VIEWER_B_TITLE_MAX_NUM}자 이내 입력해 주세요.`,
      ),
      bold: Yup.boolean(),
      color: Yup.string(),
    }),
    subTitle: Yup.object().shape({
      text: Yup.string().max(
        MEDIA_VIEWER_B_SUBTITLE_MAX_NUM,
        `최대 ${MEDIA_VIEWER_B_SUBTITLE_MAX_NUM}자 이내 입력해 주세요.`,
      ),
      bold: Yup.boolean(),
      color: Yup.string(),
    }),
    description: Yup.object().shape({
      text: Yup.string().max(MEDIA_VIEWER_B_DESC_MAX_NUM, `최대 ${MEDIA_VIEWER_B_DESC_MAX_NUM}자 이내 입력해 주세요.`),
      bold: Yup.boolean(),
      color: Yup.string(),
    }),
    ...
    mainMediaTitle: Yup.object().shape({
      title: Yup.string().max(
        MEDIA_VIEWER_B_MEDIA_TITLE_MAX_NUM,
        `최대 ${MEDIA_VIEWER_B_MEDIA_TITLE_MAX_NUM}자 이내 입력해 주세요.`,
      ),
      subTitle: Yup.string().max(
        MEDIA_VIEWER_B_MEDIA_SUBTITLE_MAX_NUM,
        `최대 ${MEDIA_VIEWER_B_MEDIA_SUBTITLE_MAX_NUM}자 이내 입력해 주세요.`,
      ),
    }),
    subMediaTitleList: Yup.array().of(
      Yup.object().shape({
        title: Yup.string().max(
          MEDIA_VIEWER_B_MEDIA_TITLE_MAX_NUM,
          `최대 ${MEDIA_VIEWER_B_MEDIA_TITLE_MAX_NUM}자 이내 입력해 주세요.`,
    ...
    useMediaText: Yup.boolean(),
    mediaTextColor: Yup.string(),
